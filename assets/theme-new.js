      ...
      value: function _updateAddToCartButton(newVariant) {
        ...
        if (!newVariant) {
          ...
          if (newVariant['available']) {
            ...
            $('.Product__Info .perm-sellout').hide();
            $('.Product__Info .perm-sellout p').html("");
			$('.ProductForm.pso').removeClass('hide-bis-button');
			$('.ProductForm.pso #BIS_trigger').removeClass('hide-bis');
            ...
            $('.Product__Info .perm-sellout').hide();
            var variant = newVariant.option1;
            ...
            if (psoElement) {
			  ...
			  $(psoElement).parents('.Product__Info').find('.ProductForm.pso').find('#BIS_trigger').addClass('hide-bis');
            } else {
			  $('.ProductForm.pso').removeClass('hide-bis-button');
			  $('.ProductForm.pso #BIS_trigger').removeClass('hide-bis');
            }
        ...
        if (this.slideshowMobileNav) {
          ...
          slideshowMobileNavDelegate.on('click', '.Product__SlideshowNavArrow', function (event, element) {
            ...
            if (element.getAttribute('data-direction') === 'next') {
              if (!$('.Product__SlideshowMobileNav .dot.is-selected').next().hasClass('hide-slider-dot')) {
              	_this57.productSlideshow.next();
              }
            } else {
              if (!$('.Product__SlideshowMobileNav .dot.is-selected').prev().hasClass('hide-slider-dot')) {
