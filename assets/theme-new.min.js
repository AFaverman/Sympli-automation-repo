          ...
          return _createClass(e, [{
              ...
              value: function(e, t) {
                  ...
                  if (e) {
                      ...
                      var country_code_format = window.theme.moneyWithCurrencyFormat;
                    	 var result = country_code_format.toString();
                      var USD = result.indexOf("USD");
                      var CAD = result.indexOf("CAD");
                      if (USD >= 0){
                        country_code = "USD ";
                      }
                      ...
                      if (t && t.price === e.price && t.compare_at_price === e.compare_at_price)
                          return;
                      i.innerHTML = "",
                      e.compare_at_price > e.price ? (i.innerHTML += '<span class="ProductMeta__Price Price Price--highlight Text--subdued u-h4" data-money-convertible>' + country_code + r.default.formatMoney(e.price, window.theme.moneyFormat) + "</span>",
                      i.innerHTML += '<span class="ProductMeta__Price Price Price--compareAt Text--subdued u-h4" data-money-convertible>' + country_code + r.default.formatMoney(e.compare_at_price, window.theme.moneyFormat) + "</span>") : i.innerHTML += '<span class="ProductMeta__Price Price Text--subdued u-h4" data-money-convertible>' + country_code + r.default.formatMoney(e.price, window.theme.moneyFormat) + "</span>",
                      i.style.display = ""
              ...
              value: function(e) {
                  ...
                  e)
                      if (e.available)
                          ...
                          $(".Product__Info .perm-sellout").hide();
                          var s = e.option1
                            , a = $('input[name="' + ("PSO " + s) + '"]')[0];
                          a ? ($(a).parent().show().find("p").html("WeÃ¢â‚¬â„¢re sorry, this product is permanently sold out. <span class='perm-sellout-redirect'><a href='/apps/store-locator'>Visit a retailer near you</a></span> to see if they have this item in stock."),
                          $(a).parents(".Product__Info").find(".ProductForm.pso").find("#BIS_trigger").addClass("hide-bis")) : ($(".ProductForm.pso").removeClass("hide-bis-button"),
                          $(".ProductForm.pso #BIS_trigger").removeClass("hide-bis"))
                      }
                  else
                      n.setAttribute("disabled", "disabled"),
              ...
              value: function() {
                  ...
                  this.slideshowMobileNav) {
                      ...
                      t.on("click", ".Product__SlideshowNavArrow", function(t, i) {
                          e._slideWillChange(),
                          "next" === i.getAttribute("data-direction") ? $(".Product__SlideshowMobileNav .dot.is-selected").next().hasClass("hide-slider-dot") || e.productSlideshow.next() : $(".Product__SlideshowMobileNav .dot.is-selected").prev().hasClass("hide-slider-dot") || e.productSlideshow.previous()
                      })
                  }
              }
          }, {
      ...
      !function() {
          ...
          window.addEventListener("resize", function() {
              ...
              fastdom.mutate(function() {
                  ...
                  l && document.documentElement.style.setProperty("--header-height", l.clientHeight + "px"))
              })
          }),
          function() {
